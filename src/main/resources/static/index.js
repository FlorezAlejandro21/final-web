  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (let object of objects) {
        ...
        trHTML +=
          '<td><button type="button" class="btn btn-outline-secondary" onclick="actualizarEstudiante(' +
          object["id"] +
          ')">Editar</button>';
          trHTML += '<td><button type="button" class="btn btn-outline-secondary" onclick="redirigirPagina(' + object["id"] + ')">Notas</button>';
        trHTML +=
          '<button type="button" class="btn btn-outline-danger" onclick="borrarEstudiante(' +
          object["id"] +
          ')">Borrar</button></td>';
        trHTML += "</tr>";
      }
...
function redirigirPagina(id) {
  var urlDestino = 'pagina2.html?id=' + id;
